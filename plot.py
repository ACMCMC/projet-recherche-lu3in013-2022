...
if __name__ == "__main__":
    ...
    # Graphs in EPS, for LaTeX
    logger.start_plot()
    logger.plot_rewards_mean_and_individuals()
    logger.end_plot(output_dir + 'reward_individuals.eps')
    logger.start_plot()
    logger.plot_rewards_mean_and_std()
    logger.end_plot(output_dir + 'reward_std.eps')
    logger.start_plot()
    logger.plot_hyperparam_individuals('a2c_coef', line_color='green')
    logger.end_plot(output_dir + 'a2c_coef_inds.eps')
    logger.start_plot()
    logger.plot_hyperparam_mean_and_std('a2c_coef', line_color='green')
    logger.end_plot(output_dir + 'a2c_coef_mean_and_std.eps')
    logger.start_plot()
    logger.plot_hyperparam_individuals('critic_coef', line_color='red')
    logger.end_plot(output_dir + 'critic_coef_inds.eps')
    logger.start_plot()
    logger.plot_hyperparam_mean_and_std('critic_coef', line_color='red')
    logger.end_plot(output_dir + 'critic_coef_mean_and_std.eps')
    logger.start_plot()
    logger.plot_hyperparam_individuals('entropy_coef', line_color='orange')
    logger.end_plot(output_dir + 'entropy_coef_inds.eps')
    logger.start_plot()
    logger.plot_hyperparam_mean_and_std('entropy_coef', line_color='orange')
    logger.end_plot(output_dir + 'entropy_coef_mean_and_std.eps')