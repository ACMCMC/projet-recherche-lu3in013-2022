...
if __name__ == "__main__":
    ...
    logger.end_plot('reward_individuals.png')
    logger.start_plot()
    logger.plot_rewards_mean_and_std()
    logger.end_plot('reward_std.png')
    logger.start_plot()
    ...
    logger.start_plot()
    logger.plot_rewards_mean_and_individuals()
    logger.end_plot('reward_individuals.eps')
    logger.start_plot()
    logger.plot_rewards_mean_and_std()
    logger.end_plot('reward_std.eps')
    logger.start_plot()
    logger.plot_hyperparam_individuals('a2c_coef', line_color='green')
    logger.end_plot('a2c_coef_inds.eps')
    logger.start_plot()
    logger.plot_hyperparam_mean_and_std('a2c_coef', line_color='green')
    logger.end_plot('a2c_coef_mean_and_std.eps')
    logger.start_plot()
    logger.plot_hyperparam_individuals('critic_coef', line_color='red')
    logger.end_plot('critic_coef_inds.eps')
    logger.start_plot()
    logger.plot_hyperparam_mean_and_std('critic_coef', line_color='red')
    logger.end_plot('critic_coef_mean_and_std.eps')
    logger.start_plot()
    logger.plot_hyperparam_individuals('entropy_coef', line_color='orange')
    logger.end_plot('entropy_coef_inds.eps')
    logger.start_plot()
    logger.plot_hyperparam_mean_and_std('entropy_coef', line_color='orange')
    logger.end_plot('entropy_coef_mean_and_std.eps')